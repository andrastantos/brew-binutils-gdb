...
enum TOK_SUBTYPE_PLUS_MINUS {
  ST_PLUS = 4, // IMPORTANT! MUST MATCH FIELD_C FOR THE BINARY + OPERATOR
  ST_MINUS = 5 // IMPORTANT! MUST MATCH FIELD_C FOR THE BINARY - OPERATOR
};
