...
static const token_declS token_library[] = {
  ...
  { "fill",         T_INSN,          0x0000 },
  { "break",        T_INSN,          0x0001 },
  { "syscall",      T_INSN,          0x0002 },
  { "sii",          T_INSN,          0x0006 },
  { "hwi",          T_INSN,          0x0007 },
  { "stm",          T_INSN,          0x0008 },
  { "woi",          T_INSN,          0x0009 },
  { "swi",          T_SWI,           0x0000 },
  { "fence",        T_FENCE,         0x0010 },
  { "floor",        T_PREFIX_OP,     0x0800 },
  { "sum",          T_PREFIX_OP,     0x0b00 },
  { "rsqrt",        T_PREFIX_OP,     0x0a00 },
  { "bsi",          T_PREFIX_OP,     0x0500 },
  { "wsi",          T_PREFIX_OP,     0x0600 },
  { "-",            T_MINUS,         0 },
  { "~",            T_TILDE,         0 },
